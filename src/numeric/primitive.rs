...
add_checked_dyadic_trait!(CheckedAdd, Add, checked_add, usize, i64);
add_checked_dyadic_trait!(CheckedSub, Sub, checked_sub, usize, i64);
add_checked_dyadic_trait!(CheckedMul, Mul, checked_mul, usize, i64);
add_checked_dyadic_trait!(CheckedDiv, Div, checked_div, usize, i64);
...
add_checked_monadic_trait!(CheckedNeg, checked_neg, Neg, neg, i64, f64); 
...
pub trait NumericPrimitive:
    ...
    AsPrimitive<f64> + AsPrimitive<i64> + AsPrimitive<usize> +
    PartialOrd + NumCast
{}
